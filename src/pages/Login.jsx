                ...
                <div className="w-[70%]   h-[70%] flex space-x-4 p-6">
                    ...
                    <div className="flex flex-1 flex-col justify-center space-y-4 p-2">
                        <div className="bg-white p-6 rounded-md flex flex-col justify-between pl-5 space-y-4">
                            ...
                            <input type="email" className="h-[50px] rounded-[10px]  text-lg w-full border focus:outline-0 p-5" placeholder="Enter email address" />
                            <button className="h-[50px] rounded-[10px]  text-lg text-white w-full bg-blue-500 focus:outline-0 flex justify-center items-center" >Login</button>

                            <span className="text-center" >Forgot password?</span>

                            <button className="h-[50px] rounded-[10px]   text-lg text-white mx-auto w-1/2 bg-green-500 focus:outline-0 flex justify-center items-center" >Register</button>
                        </div>
